...
displayWidth = 897
displayHeight = 531
startOfAlgorithmX = 359
startOfAlgorithmY = 269.25
...
blue = (0,0,255)
green = (0,255,0)
originalCoordinateX = 359
originalCoordinateY = 269.25
...
while running:
    algorithm.quitGame()
    pygame.display.update()
    screen.blit(algorithm.image,algorithm.rect)
